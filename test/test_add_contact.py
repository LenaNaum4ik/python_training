...
def test_add_contact(app):
     ...
     app.contact.create(Contact(firstname="11111", middlename="2222", lastname="33333", nickname="444444", title="5555", company="666", address="777777", home="88888888888",
...
def test_add_empty_contact(app):
     app.session.login(username="admin", password="secret")
     app.contact.create(Contact(firstname="", middlename="", lastname="", nickname="", title="", company="", address="", home="",

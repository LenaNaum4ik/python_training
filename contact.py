...
class contact(unittest.TestCase):
    ...
    def test_contact(self):
        ...
        self.creat_contact(wd, firstname="uuuuuuuu", middlename="ffffffffffffff", lastname="ddddddddd", nickname="eeeeeeeee", title="eeeeeeee", company="yyyyyyyyyyyy",
    ...
    def creat_contact(self, wd, firstname, middlename, lastname, nickname, title, company, address, home, mobile, work,
                      fax, email, email2, notes, homepage, byer, ayar, address2, phone2, email3):
        ...
        wd.find_element_by_name("byear").send_keys(byer)
        ...
        wd.find_element_by_name("ayear").send_keys(ayar)
